...
![HTTP-Protocol-Basics](HTTP基础/HTTP-Protocol-Basics.jpg)
...
![http-request-response-structure](HTTP基础/http-request-response-structure.jpg)
...
![url-example-1](HTTP基础/url-example-1.jpg)

URL 通常包含被浏览器隐藏的端口号，但是你可以手动添加它：

![url-example-with-port](HTTP基础/url-example-with-port.jpg)
...
![browser-request](HTTP基础/browser-request.jpg)

这是浏览器显示的响应：

![browser-response](HTTP基础/browser-response.jpg)

这是后台发生的 http 请求响应：

![HTTP-Request-Response-example](HTTP基础/HTTP-Request-Response-example.jpg)
